...
func (x *QuizReq) GetAnswer() string {
	if x != nil {
		return x.Answer
	}
	return ""
...
func (x *QuizRes) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_quiz_proto_rawDesc = []byte{
	...
	0x69, 0x7a, 0x61, 0x70, 0x70, 0x22, 0x21, 0x0a, 0x07, 0x51, 0x75, 0x69, 0x7a, 0x52, 0x65, 0x71,
	0x12, 0x16, 0x0a, 0x06, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x22, 0x23, 0x0a, 0x07, 0x51, 0x75, 0x69, 0x7a,
	...
	0x0b, 0x51, 0x75, 0x69, 0x7a, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x32, 0x0a, 0x08,
	0x50, 0x6c, 0x61, 0x79, 0x51, 0x75, 0x69, 0x7a, 0x12, 0x10, 0x2e, 0x71, 0x75, 0x69, 0x7a, 0x61,
	0x70, 0x70, 0x2e, 0x51, 0x75, 0x69, 0x7a, 0x52, 0x65, 0x71, 0x1a, 0x10, 0x2e, 0x71, 0x75, 0x69,
	0x7a, 0x61, 0x70, 0x70, 0x2e, 0x51, 0x75, 0x69, 0x7a, 0x52, 0x65, 0x73, 0x28, 0x01, 0x30, 0x01,
...
var file_quiz_proto_goTypes = []interface{}{
	(*QuizReq)(nil), // 0: quizapp.QuizReq
	(*QuizRes)(nil), // 1: quizapp.QuizRes
}
var file_quiz_proto_depIdxs = []int32{
	0, // 0: quizapp.QuizService.PlayQuiz:input_type -> quizapp.QuizReq
	1, // 1: quizapp.QuizService.PlayQuiz:output_type -> quizapp.QuizRes
